                        ...
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                <div class="row gx-3 mb-6">
                                    ...
                                    <select id="flow-rate" class="form-select" v-model="unity_debit">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="row gx-3 mb-6">
                                    ...
                                    <div class="col-md-4">
                                    <label class="small mb-1" for="flow-rate" style="float: left">Unité</label>
                                    <select id="flow-rate" class="form-select" v-model="unity_debitEdit">
                                        <option value="m³/h">m³/h</option>
                                        <option value="l/s">l/s</option>
                                    </select>
                                    </div>
            ...
            <div class="col-md-6">
              <div class="row gx-3 mb-3">
                <div class="col-md-4 offset-md-2">
                  <div class="image">
                    <img :src="'/storage/img/pompes/'+imageShow"/>
                  </div>
                </div>
              </div>
            </div>
...
.image img {
  ...
  transition: all 1.5s ease-in-out; /* Adjust the transition speed if needed */
}

.image:hover img {
  transform: scale(2.2); /* Increase the scale factor for a smoother zoom effect */
  cursor: pointer;
}
