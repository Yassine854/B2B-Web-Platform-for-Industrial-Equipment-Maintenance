        ...
        <form>
          <div class="row gx-4">
            <div class="col-md-6">
              ...
              <div class="mb-3">
                <label class="small float-left" for="pression">Vide/Pression</label>
            ...
            <div class="col-md-6">
              <div class="d-flex align-items-center justify-content-center h-100">
                <div class="image shadow">
                  <img v-if="imageShow" :src="'/storage/img/pompes/' + imageShow" class="centered-image img-fluid" />
                  <img v-else :src="'/storage/img/NoImage.png'" class="centered-image img-fluid" />
                </div>
              </div>
            </div>
          </div>
        ...
        <table class="table table-bordered">
          ...
          <tbody v-if="products.length > 0">
            <tr v-for="product in displayedproducts" :key="product.id">
              ...
              <td>{{ product.name }}</td>
              <td v-if="product.image"><img :src="'/storage/img/pompes/'+product.image" width="100" /></td>
              <td v-else><img :src="'/storage/img/NoImage.png'" width="100" /></td>
