...
//Charts
Route::get('/interventions/DonutChart',[InterventionController::class,'DonutChart']);
Route::get('/interventions/ClientsBarChart',[InterventionController::class,'ClientsBarChart']);
Route::get('/interventions/MonthlyBarChart',[InterventionController::class,'MonthlyBarChart']);
